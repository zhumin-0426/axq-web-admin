  ...
  <div class="auth">
    ...
    <div class="a-right" v-loading="layoutAuthLoading">
      <div class="r-header">
        ...
        <div class="h-right">
          <div class="r-link2v1" @click="toV1">
            <span>返回旧版</span>
          </div>
          <div class="r-search">
      ...
      <div class="r-main">
        ...
        <div class="m-footer">
          ...
          <div class="f-copyright">
            <span>Copyright © 2021 AOXUEQI</span>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    toV1 () {
      this.$confirm('旧版ERP只提供旧数据查询，请勿新增数据，防止数据丢失！', '登出提示', {
        confirmButtonText: '我知道了',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(() => {
        window.open('//erp.aoxueqio2o.com');
      }).catch(() => {
      });
    },
    toggleFullScreen () {
    ...
    deleteHistoryBar (index) {
      ...
      historyBar.delete(index);
      this.SET_HISTORY_BAR(historyBar.all());
