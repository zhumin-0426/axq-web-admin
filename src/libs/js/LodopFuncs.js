...
function getLodop (oOBJECT, oEMBED) {
  const strHtmInstall = '<br><font color=\'#FF00FF\'>打印控件未安装!点击这里<a href=\'install_lodop32.exe\' target=\'_self\'>执行安装</a>,安装后请刷新页面或重新进入。</font>';
  const strHtmUpdate = '<br><font color=\'#FF00FF\'>打印控件需要升级!点击这里<a href=\'install_lodop32.exe\' target=\'_self\'>执行升级</a>,升级后请重新进入。</font>';
  const strHtm64_Install = '<br><font color=\'#FF00FF\'>打印控件未安装!点击这里<a href=\'install_lodop64.exe\' target=\'_self\'>执行安装</a>,安装后请刷新页面或重新进入。</font>';
  const strHtm64_Update = '<br><font color=\'#FF00FF\'>打印控件需要升级!点击这里<a href=\'install_lodop64.exe\' target=\'_self\'>执行升级</a>,升级后请重新进入。</font>';
  ...
  const strCLodopInstall_1 = '<br><font color=\'#FF00FF\'>Web打印服务CLodop未安装启动，点击这里<a href=\'CLodop_Setup_for_Win32NT.exe\' target=\'_self\'>下载执行安装</a>';
  ...
  const strCLodopUpdate = '<br><font color=\'#FF00FF\'>Web打印服务CLodop需升级!点击这里<a href=\'CLodop_Setup_for_Win32NT.exe\' target=\'_self\'>执行升级</a>,升级后请刷新页面。</font>';
  let LODOP;
  try {
    const ua = navigator.userAgent;
