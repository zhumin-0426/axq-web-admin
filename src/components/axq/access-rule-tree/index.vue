 ...
 * @LastEditTime: 2021-09-27 14:57:06
 * @LastEditors: 码上talk|RC
 * @Description:
 * @FilePath: /web-admin/src/components/axq/access-rule-tree/index.vue
 * @微信:  13680065830
 * @邮箱:  3189482282@qq.com
 * @oops: Just do what I think it is right
-->
<template>
  <div class="axq-access-rule-tree">
    <el-tree
      :props="props"
      :data="data"
      node-key="id"
...
export default {
  ...
  methods: {
    _loadAccessRuleList () {
      AxqAccessRule.sendApi('accessRuleList', { params: {}, data: {} }).then(res => {
